...
get_filename_component(_filename "/home/cc/ee106a/fl21/class/ee106a-agw/ros_workspaces/lab2/src/turtle_patrol/srv/Patrol.srv" NAME_WE)
add_custom_target(_turtle_patrol_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "turtle_patrol" "/home/cc/ee106a/fl21/class/ee106a-agw/ros_workspaces/lab2/src/turtle_patrol/srv/Patrol.srv" "geometry_msgs/Twist:geometry_msgs/Vector3"
)
...
_generate_srv_cpp(turtle_patrol
  "/home/cc/ee106a/fl21/class/ee106a-agw/ros_workspaces/lab2/src/turtle_patrol/srv/Patrol.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtle_patrol)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtle_patrol\")")
  # install generated code
  install(
